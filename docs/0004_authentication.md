...
[environment.settings.auth]
  ...
  # There are a few. This field is a ValueSource 
  # required
  # When `prompt` is used, the user will be prompted every time
  username = "username"

  # password is the password for the user. This field is a ValueSource
  # Optional
...
[environment.settings.auth]
  ...
  # Token specifies the oauth token to use, This field is a ValueSource.
...
[environment.settings.auth]
  ...
  # client_id specifies the oauth client id. This field is a ValueSource
  ...
  # ValueSource when configured with `prompt` the user will be prompted
